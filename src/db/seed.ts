...
const SEED_PRODUCTS = [
  ...
  {
    name: 'Белокочанная капуста (свежая)',
    brand: null,
    kcalPer100g: 27,
    protein: 1.8,
    fat: 0.1,
